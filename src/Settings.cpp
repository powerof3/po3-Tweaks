...
void Settings::Fixes::Load(CSimpleIniA& a_ini)
{
	...
	detail::get_value(a_ini, toggleGlobalAIFix, section, "Toggle Global AI Fix", ";TAI console command/Debug.ToggleAI() now toggles all loaded NPC AI");
	...
	detail::get_value(a_ini, flagStolenProduce, section, "Flag Stolen Produce", ";Mark flora and tree items as stolen, when pulled from leveled lists");
